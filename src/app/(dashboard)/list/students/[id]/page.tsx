    ...
    <div className='flex-1 p-4 flex flex-col gap-4 xl:flex-row'>
        ...
        <div className='bg-white p-4 rounded-md'>
          ...
          <div className='mt-4 flex gap-4 flex-wrap text-xs text-gray-500'>
            <Link className='p-3 rounded-md bg-buriiSkyLight' href="/">Student&apos;s Lessons</Link>
            <Link className='p-3 rounded-md bg-buriiPurpleLight' href="/">Student&apos;s Teachers</Link>
            <Link className='p-3 rounded-md bg-buriiYellowLight' href="/">Student&apos;s Results</Link>
            <Link className='p-3 rounded-md bg-pink-300' href="/">Student&apos;s Exams</Link>
            <Link className='p-3 rounded-md bg-buriiYellow' href="/">Student&apos;s Assigments</Link>
          </div>
        </div>
        <Performance/>
        <Announcements/>
